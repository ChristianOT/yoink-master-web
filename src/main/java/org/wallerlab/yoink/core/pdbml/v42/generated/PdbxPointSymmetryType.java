...
public class PdbxPointSymmetryType {
    ...
    public static class PdbxPointSymmetry {
        ...
        @XmlElementRef(name = "H-M_notation", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "circular_symmetry", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> circularSymmetry;
         ...
         *     
         */
        public JAXBElement<BigInteger> getCircularSymmetry() {
         ...
         *     
         */
        public void setCircularSymmetry(JAXBElement<BigInteger> value) {
