...
public class CellMeasurementType {
    ...
    public static class CellMeasurement {
        ...
        @XmlElementRef(name = "pressure", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<CellMeasurementType.CellMeasurement.Pressure> pressure;
        @XmlElementRef(name = "pressure_esd", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<CellMeasurementType.CellMeasurement.PressureEsd> pressureEsd;
        @XmlElementRef(name = "radiation", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> radiation;
        @XmlElementRef(name = "reflns_used", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "temp_esd", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
