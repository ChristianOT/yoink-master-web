...
public class StructType {
    ...
    public static class Struct {
        ...
        @XmlElementRef(name = "pdbx_CASP_flag", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxCASPFlag;
        @XmlElementRef(name = "pdbx_descriptor", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "pdbx_model_details", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxModelDetails;
        @XmlElementRef(name = "pdbx_model_type_details", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
