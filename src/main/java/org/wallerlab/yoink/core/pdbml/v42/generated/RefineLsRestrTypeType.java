...
public class RefineLsRestrTypeType {
    ...
    public static class RefineLsRestrType {
        ...
        @XmlElementRef(name = "distance_cutoff_high", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> distanceCutoffHigh;
        @XmlElementRef(name = "distance_cutoff_low", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> distanceCutoffLow;
         ...
         *     
         */
        public JAXBElement<BigDecimal> getDistanceCutoffHigh() {
         ...
         *     
         */
        public void setDistanceCutoffHigh(JAXBElement<BigDecimal> value) {
         ...
         *     
         */
        public JAXBElement<BigDecimal> getDistanceCutoffLow() {
         ...
         *     
         */
        public void setDistanceCutoffLow(JAXBElement<BigDecimal> value) {
