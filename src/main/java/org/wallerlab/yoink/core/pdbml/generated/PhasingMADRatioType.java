...
public class PhasingMADRatioType {
    ...
    public static class PhasingMADRatio {
        ...
        @XmlElementRef(name = "ratio_one_wl", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> ratioOneWl;
        @XmlElementRef(name = "ratio_one_wl_centric", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> ratioOneWlCentric;
        @XmlElementRef(name = "ratio_two_wl", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
