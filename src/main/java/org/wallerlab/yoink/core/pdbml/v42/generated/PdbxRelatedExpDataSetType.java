...
public class PdbxRelatedExpDataSetType {
    ...
    public static class PdbxRelatedExpDataSet {
        ...
        @XmlElement(name = "data_set_type", required = true, nillable = true)
        ...
        @XmlElementRef(name = "metadata_reference", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
