...
public class Em3DFittingType {
    ...
    public static class Em3DFitting {
        ...
        @XmlElementRef(name = "overall_b_value", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> overallBValue;
        @XmlElementRef(name = "ref_protocol", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> refProtocol;
        @XmlElementRef(name = "ref_space", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "target_criteria", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
