 ...
 *                         &lt;enumeration value="Partnership for Nuclear Receptor Signaling Code Biology"/>
...
public class PdbxSGProjectType {
    ...
    public static class PdbxSGProject {
        ...
        @XmlElementRef(name = "full_name_of_center", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> fullNameOfCenter;
        @XmlElementRef(name = "initial_of_center", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> initialOfCenter;
        @XmlElementRef(name = "project_name", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
