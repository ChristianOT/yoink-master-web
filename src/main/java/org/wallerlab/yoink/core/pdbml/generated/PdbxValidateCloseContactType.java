...
public class PdbxValidateCloseContactType {
    ...
    public static class PdbxValidateCloseContact {
        ...
        @XmlElementRef(name = "symm_as_xyz_1", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> symmAsXyz1;
        @XmlElementRef(name = "symm_as_xyz_2", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
