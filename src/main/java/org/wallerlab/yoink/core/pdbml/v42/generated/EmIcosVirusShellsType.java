...
public class EmIcosVirusShellsType {
    ...
    public static class EmIcosVirusShells {
        ...
        @XmlElementRef(name = "shell_diameter", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<EmIcosVirusShellsType.EmIcosVirusShells.ShellDiameter> shellDiameter;
        @XmlElementRef(name = "triangulation_num", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
