...
public class StructRefSeqType {
    ...
    public static class StructRefSeq {
        ...
        @XmlElementRef(name = "pdbx_auth_seq_align_beg", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxAuthSeqAlignBeg;
        @XmlElementRef(name = "pdbx_auth_seq_align_end", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "pdbx_db_align_beg_ins_code", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxDbAlignBegInsCode;
        @XmlElementRef(name = "pdbx_db_align_end_ins_code", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxDbAlignEndInsCode;
        @XmlElementRef(name = "pdbx_seq_align_beg_ins_code", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxSeqAlignBegInsCode;
        @XmlElementRef(name = "pdbx_seq_align_end_ins_code", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
