...
public class DiffrnAttenuatorType {
    ...
    public static class DiffrnAttenuator {
        ...
        @XmlElementRef(name = "material", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> material;
        @XmlElementRef(name = "scale", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
