...
public class ExptlType {
    ...
    public static class Exptl {
        ...
        @XmlElementRef(name = "absorpt_coefficient_mu", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> absorptCoefficientMu;
        @XmlElementRef(name = "absorpt_correction_T_max", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> absorptCorrectionTMax;
        @XmlElementRef(name = "absorpt_correction_T_min", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> absorptCorrectionTMin;
        @XmlElementRef(name = "absorpt_correction_type", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> absorptCorrectionType;
        @XmlElementRef(name = "absorpt_process_details", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> absorptProcessDetails;
        @XmlElementRef(name = "crystals_number", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> crystalsNumber;
         ...
         *     
         */
        public JAXBElement<String> getAbsorptCoefficientMu() {
         ...
         *     
         */
        public void setAbsorptCoefficientMu(JAXBElement<String> value) {
         ...
         *     
         */
        public JAXBElement<String> getAbsorptCorrectionTMax() {
         ...
         *     
         */
        public void setAbsorptCorrectionTMax(JAXBElement<String> value) {
         ...
         *     
         */
        public JAXBElement<String> getAbsorptCorrectionTMin() {
         ...
         *     
         */
        public void setAbsorptCorrectionTMin(JAXBElement<String> value) {
         ...
         *     
         */
        public JAXBElement<String> getCrystalsNumber() {
         ...
         *     
         */
        public void setCrystalsNumber(JAXBElement<String> value) {
