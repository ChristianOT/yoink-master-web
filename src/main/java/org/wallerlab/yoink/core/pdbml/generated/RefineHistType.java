...
public class RefineHistType {
    ...
    public static class RefineHist {
        ...
        @XmlElementRef(name = "number_atoms_solvent", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> numberAtomsSolvent;
        @XmlElementRef(name = "number_atoms_total", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> numberAtomsTotal;
        ...
        @XmlElementRef(name = "pdbx_B_iso_mean_ligand", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> pdbxBIsoMeanLigand;
        @XmlElementRef(name = "pdbx_B_iso_mean_solvent", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> pdbxBIsoMeanSolvent;
        @XmlElementRef(name = "pdbx_number_atoms_carb", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> pdbxNumberAtomsCarb;
        @XmlElementRef(name = "pdbx_number_atoms_ligand", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> pdbxNumberAtomsLigand;
        @XmlElementRef(name = "pdbx_number_atoms_lipid", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> pdbxNumberAtomsLipid;
        @XmlElementRef(name = "pdbx_number_atoms_nucleic_acid", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> pdbxNumberAtomsNucleicAcid;
        @XmlElementRef(name = "pdbx_number_atoms_protein", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> pdbxNumberAtomsProtein;
        @XmlElementRef(name = "pdbx_number_residues_total", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> pdbxNumberResiduesTotal;
        @XmlElementRef(name = "pdbx_pseudo_atom_details", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
         ...
         *     
         */
        public JAXBElement<String> getNumberAtomsSolvent() {
         ...
         *     
         */
        public void setNumberAtomsSolvent(JAXBElement<String> value) {
         ...
         *     
         */
        public JAXBElement<String> getNumberAtomsTotal() {
         ...
         *     
         */
        public void setNumberAtomsTotal(JAXBElement<String> value) {
