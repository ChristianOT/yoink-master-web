...
public class DiffrnSourceType {
    ...
    public static class DiffrnSource {
        ...
        @XmlElementRef(name = "current", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "pdbx_synchrotron_beamline", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxSynchrotronBeamline;
        @XmlElementRef(name = "pdbx_synchrotron_site", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "size", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "take-off_angle", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> takeOffAngle;
        @XmlElementRef(name = "target", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "voltage", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
         ...
         *     
         */
        public JAXBElement<BigDecimal> getTakeOffAngle() {
            return takeOffAngle;
        }
         ...
         *     
         */
        public void setTakeOffAngle(JAXBElement<BigDecimal> value) {
