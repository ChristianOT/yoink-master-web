...
public class PdbxEntitySrcSynType {
    ...
    public static class PdbxEntitySrcSyn {
        ...
        @XmlElementRef(name = "ncbi_taxonomy_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> ncbiTaxonomyId;
        @XmlElementRef(name = "organism_common_name", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
