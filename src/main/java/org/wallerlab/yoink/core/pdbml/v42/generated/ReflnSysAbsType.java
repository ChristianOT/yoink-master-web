...
public class ReflnSysAbsType {
    ...
    public static class ReflnSysAbs {
        ...
        @XmlElementRef(name = "I", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<ReflnSysAbsType.ReflnSysAbs.I> i;
        @XmlElementRef(name = "I_over_sigmaI", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> iOverSigmaI;
        @XmlElementRef(name = "sigmaI", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
