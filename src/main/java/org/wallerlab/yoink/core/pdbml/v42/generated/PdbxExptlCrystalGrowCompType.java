...
public class PdbxExptlCrystalGrowCompType {
    ...
    public static class PdbxExptlCrystalGrowComp {
        ...
        @XmlElementRef(name = "comp_name", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "conc_range", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
