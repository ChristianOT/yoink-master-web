...
public class PdbxNmrConstraintFileType {
    ...
    public static class PdbxNmrConstraintFile {
        ...
        @XmlElementRef(name = "constraint_number", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "software_ordinal", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
