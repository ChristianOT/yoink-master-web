...
public class PdbxReferenceEntityPolySeqType {
    ...
    public static class PdbxReferenceEntityPolySeq {
        ...
        @XmlElementRef(name = "observed", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> observed;
        @XmlElementRef(name = "parent_mon_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
