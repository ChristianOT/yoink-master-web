...
public class ReflnsClassType {
    ...
    public static class ReflnsClass {
        ...
        @XmlElementRef(name = "number_total", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> numberTotal;
         ...
         *     
         */
        public JAXBElement<BigInteger> getNumberTotal() {
            return numberTotal;
        }
         ...
         *     
         */
        public void setNumberTotal(JAXBElement<BigInteger> value) {
