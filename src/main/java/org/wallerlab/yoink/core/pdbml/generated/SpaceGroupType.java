 ...
 *                             &lt;maxExclusive value="230"/>
 *                           &lt;/restriction>
 *                         &lt;/simpleType>
 *                         &lt;simpleType>
 *                           &lt;restriction base="{http://www.w3.org/2001/XMLSchema}integer">
 *                             &lt;minInclusive value="230"/>
...
public class SpaceGroupType {
    ...
    public static class SpaceGroup {
        ...
        @XmlElementRef(name = "IT_number", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> itNumber;
        @XmlElementRef(name = "crystal_system", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> crystalSystem;
        @XmlElementRef(name = "name_H-M_alt", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> nameHMAlt;
        @XmlElementRef(name = "name_Hall", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
         ...
         *     
         */
        public JAXBElement<String> getITNumber() {
            return itNumber;
        }
         ...
         *     
         */
        public void setITNumber(JAXBElement<String> value) {
            this.itNumber = value;
        }
