...
public class DiffrnRadiationType {
    ...
    public static class DiffrnRadiation {
        ...
        @XmlElementRef(name = "collimation", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> collimation;
        @XmlElementRef(name = "filter_edge", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> filterEdge;
        @XmlElementRef(name = "inhomogeneity", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> inhomogeneity;
        @XmlElementRef(name = "monochromator", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> monochromator;
        @XmlElementRef(name = "pdbx_analyzer", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxAnalyzer;
        @XmlElementRef(name = "pdbx_diffrn_protocol", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxDiffrnProtocol;
        @XmlElementRef(name = "pdbx_monochromatic_or_laue_m_l", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxMonochromaticOrLaueML;
        @XmlElementRef(name = "pdbx_scattering_type", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "polarisn_norm", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> polarisnNorm;
        @XmlElementRef(name = "polarisn_ratio", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> polarisnRatio;
        @XmlElementRef(name = "probe", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "xray_symbol", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
         ...
         *     
         */
        public JAXBElement<String> getFilterEdge() {
            return filterEdge;
        }
         ...
         *     
         */
        public void setFilterEdge(JAXBElement<String> value) {
         ...
         *     
         */
        public JAXBElement<String> getInhomogeneity() {
         ...
         *     
         */
        public void setInhomogeneity(JAXBElement<String> value) {
         ...
         *     
         */
        public JAXBElement<String> getPolarisnNorm() {
            return polarisnNorm;
        }
         ...
         *     
         */
        public void setPolarisnNorm(JAXBElement<String> value) {
         ...
         *     
         */
        public JAXBElement<String> getPolarisnRatio() {
         ...
         *     
         */
        public void setPolarisnRatio(JAXBElement<String> value) {
