...
public class EmVirusEntityType {
    ...
    public static class EmVirusEntity {
        ...
        @XmlElementRef(name = "empty", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> empty;
        @XmlElementRef(name = "enveloped", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> enveloped;
        @XmlElementRef(name = "ictvdb_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> ictvdbId;
        @XmlElementRef(name = "virus_host_category", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> virusHostCategory;
        @XmlElementRef(name = "virus_host_growth_cell", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> virusHostGrowthCell;
        @XmlElementRef(name = "virus_host_species", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> virusHostSpecies;
        @XmlElementRef(name = "virus_isolate", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> virusIsolate;
        @XmlElementRef(name = "virus_type", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
