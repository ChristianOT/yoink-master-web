...
public class ExptlCrystalGrowType {
    ...
    public static class ExptlCrystalGrow {
        ...
        @XmlElementRef(name = "method_ref", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "pdbx_details", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxDetails;
        @XmlElementRef(name = "pdbx_pH_range", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        protected JAXBElement<BigDecimal> pressure;
        ...
        @XmlElementRef(name = "seeding", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> seeding;
        @XmlElementRef(name = "seeding_ref", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "temp_details", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
         ...
         *     
         */
        public JAXBElement<BigDecimal> getPressure() {
            return pressure;
        }
         ...
         *     
         */
        public void setPressure(JAXBElement<BigDecimal> value) {
            this.pressure = value;
        }
