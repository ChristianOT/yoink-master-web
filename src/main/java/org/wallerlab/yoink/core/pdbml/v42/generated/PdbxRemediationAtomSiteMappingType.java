...
public class PdbxRemediationAtomSiteMappingType {
    ...
    public static class PdbxRemediationAtomSiteMapping {
        ...
        @XmlElementRef(name = "auth_alt_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "pre_PDB_ins_code", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> prePDBInsCode;
        @XmlElementRef(name = "pre_auth_alt_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> preAuthAltId;
        @XmlElementRef(name = "pre_auth_asym_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> preAuthAsymId;
        @XmlElementRef(name = "pre_auth_atom_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> preAuthAtomId;
        @XmlElementRef(name = "pre_auth_comp_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> preAuthCompId;
        @XmlElementRef(name = "pre_auth_seq_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> preAuthSeqId;
        @XmlElementRef(name = "pre_group_PDB", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> preGroupPDB;
        @XmlElementRef(name = "pre_occupancy", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> preOccupancy;
        @XmlElementRef(name = "pre_pdbx_align", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
