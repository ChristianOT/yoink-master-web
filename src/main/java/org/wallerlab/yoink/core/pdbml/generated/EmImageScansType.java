...
public class EmImageScansType {
    ...
    public static class EmImageScans {
        ...
        @XmlElementRef(name = "number_digital_images", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> numberDigitalImages;
        @XmlElementRef(name = "od_range", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> odRange;
        @XmlElementRef(name = "quant_bit_size", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> quantBitSize;
        @XmlElementRef(name = "sampling_size", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<EmImageScansType.EmImageScans.SamplingSize> samplingSize;
        @XmlElementRef(name = "scanner_model", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
