...
public class StructRefSeqDifType {
    ...
    public static class StructRefSeqDif {
        ...
        @XmlElementRef(name = "db_mon_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "pdbx_auth_seq_num", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "pdbx_seq_db_accession_code", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxSeqDbAccessionCode;
        @XmlElementRef(name = "pdbx_seq_db_name", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxSeqDbName;
        @XmlElementRef(name = "pdbx_seq_db_seq_num", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
