...
public class PdbxReferenceEntityPolyLinkType {
    ...
    public static class PdbxReferenceEntityPolyLink {
        ...
        @XmlElementRef(name = "insert_code_1", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> insertCode1;
        @XmlElementRef(name = "insert_code_2", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
