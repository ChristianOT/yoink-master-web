...
public class PdbxXplorFileType {
    ...
    public static class PdbxXplorFile {
        ...
        @XmlElementRef(name = "param_file", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> paramFile;
        @XmlElementRef(name = "topol_file", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
