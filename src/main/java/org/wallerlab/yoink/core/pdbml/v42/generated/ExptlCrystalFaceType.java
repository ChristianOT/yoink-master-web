...
public class ExptlCrystalFaceType {
    ...
    public static class ExptlCrystalFace {
        ...
        @XmlElementRef(name = "diffr_chi", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<ExptlCrystalFaceType.ExptlCrystalFace.DiffrChi> diffrChi;
        @XmlElementRef(name = "diffr_kappa", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<ExptlCrystalFaceType.ExptlCrystalFace.DiffrKappa> diffrKappa;
        @XmlElementRef(name = "diffr_phi", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<ExptlCrystalFaceType.ExptlCrystalFace.DiffrPhi> diffrPhi;
        @XmlElementRef(name = "diffr_psi", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<ExptlCrystalFaceType.ExptlCrystalFace.DiffrPsi> diffrPsi;
        @XmlElementRef(name = "perp_dist", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> perpDist;
         ...
         *     
         */
        public JAXBElement<BigDecimal> getPerpDist() {
            return perpDist;
        }
         ...
         *     
         */
        public void setPerpDist(JAXBElement<BigDecimal> value) {
            this.perpDist = value;
        }
