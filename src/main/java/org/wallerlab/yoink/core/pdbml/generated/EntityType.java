...
public class EntityType {
    ...
    public static class Entity {
        ...
        @XmlElementRef(name = "pdbx_formula_weight_exptl", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxFormulaWeightExptl;
        @XmlElementRef(name = "pdbx_formula_weight_exptl_method", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "pdbx_modification", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "pdbx_number_of_molecules", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> pdbxNumberOfMolecules;
        @XmlElementRef(name = "pdbx_parent_entity_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxParentEntityId;
        @XmlElementRef(name = "pdbx_target_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> pdbxTargetId;
        @XmlElementRef(name = "src_method", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
         ...
         *     
         */
        public JAXBElement<String> getPdbxFormulaWeightExptl() {
         ...
         *     
         */
        public void setPdbxFormulaWeightExptl(JAXBElement<String> value) {
