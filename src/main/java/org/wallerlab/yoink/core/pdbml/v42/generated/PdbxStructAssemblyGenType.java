...
public class PdbxStructAssemblyGenType {
    ...
    public static class PdbxStructAssemblyGen {
        ...
        @XmlElementRef(name = "auth_asym_id_list", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> authAsymIdList;
        @XmlElementRef(name = "entity_inst_id", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
