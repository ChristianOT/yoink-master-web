...
public class EmElectronDiffractionPatternType {
    ...
    public static class EmElectronDiffractionPattern {
        ...
        @XmlElementRef(name = "num_images_by_tilt_angle", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> numImagesByTiltAngle;
        @XmlElementRef(name = "num_patterns_by_tilt_angle", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> numPatternsByTiltAngle;
        @XmlElementRef(name = "tilt_angle", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
