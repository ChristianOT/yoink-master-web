...
public class PdbxValidateRmsdAngleType {
    ...
    public static class PdbxValidateRmsdAngle {
        ...
        @XmlElementRef(name = "PDB_ins_code_3", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "angle_standard_deviation", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> angleStandardDeviation;
        @XmlElementRef(name = "angle_target_value", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<PdbxValidateRmsdAngleType.PdbxValidateRmsdAngle.AngleTargetValue> angleTargetValue;
        @XmlElementRef(name = "angle_value", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "label_alt_id_3", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
         ...
         *     
         */
        public JAXBElement<String> getAngleStandardDeviation() {
         ...
         *     
         */
        public void setAngleStandardDeviation(JAXBElement<String> value) {
