...
public class PdbxReferenceEntitySrcNatType {
    ...
    public static class PdbxReferenceEntitySrcNat {
        ...
        @XmlElementRef(name = "atcc", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        ...
        @XmlElementRef(name = "taxid", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
