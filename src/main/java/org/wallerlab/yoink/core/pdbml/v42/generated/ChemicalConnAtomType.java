...
public class ChemicalConnAtomType {
    ...
    public static class ChemicalConnAtom {
        ...
        @XmlElementRef(name = "NCA", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> nca;
        @XmlElementRef(name = "NH", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> nh;
        ...
        @XmlElementRef(name = "display_x", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> displayX;
        @XmlElementRef(name = "display_y", namespace = "http://pdbml.pdb.org/schema/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> displayY;
         ...
         *     
         */
        public JAXBElement<BigInteger> getNCA() {
            return nca;
        }
         ...
         *     
         */
        public void setNCA(JAXBElement<BigInteger> value) {
            this.nca = value;
        }
         ...
         *     
         */
        public JAXBElement<BigInteger> getNH() {
            return nh;
        }
         ...
         *     
         */
        public void setNH(JAXBElement<BigInteger> value) {
            this.nh = value;
        }
         ...
         *     
         */
        public JAXBElement<BigDecimal> getDisplayX() {
            return displayX;
        }
         ...
         *     
         */
        public void setDisplayX(JAXBElement<BigDecimal> value) {
            this.displayX = value;
        }
         ...
         *     
         */
        public JAXBElement<BigDecimal> getDisplayY() {
            return displayY;
        }
         ...
         *     
         */
        public void setDisplayY(JAXBElement<BigDecimal> value) {
            this.displayY = value;
        }
