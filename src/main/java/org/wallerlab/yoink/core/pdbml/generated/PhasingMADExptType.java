...
public class PhasingMADExptType {
    ...
    public static class PhasingMADExpt {
        ...
        @XmlElementRef(name = "R_normal_all", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> rNormalAll;
        @XmlElementRef(name = "R_normal_anom_scat", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> rNormalAnomScat;
        @XmlElementRef(name = "delta_delta_phi", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> deltaDeltaPhi;
        @XmlElementRef(name = "delta_phi", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> deltaPhi;
        @XmlElementRef(name = "delta_phi_sigma", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> deltaPhiSigma;
        @XmlElementRef(name = "mean_fom", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigDecimal> meanFom;
        @XmlElementRef(name = "number_clust", namespace = "http://pdbml.pdb.org/schema/pdbx-v40.xsd", type = JAXBElement.class, required = false)
